...
Public Class AdminAssessStudentTotal
    Private Sub AdminAssessStudentTotal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AdminAssessmentStudentTotal()

    End Sub

    Public Sub AdminAssessmentStudentTotal()
        ...
        Dim command As New SqlCommand("SELECT * FROM [PROJECTF1809].[dbo].[FINAL_Course_Asessment_TestRB];", connection)
        ...
        Else
            ...
            dgvAdminAssessmentStudentTotal.DataSource = table
