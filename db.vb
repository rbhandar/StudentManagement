...
Public Class db
    ...
    Protected connection As New SqlConnection With {.ConnectionString = "Server=essql1.walton.uark.edu;Database=PROJECTF1809;User ID=PROJECTF1809;Password=KP32epv$;"}
    ' prepare a query
