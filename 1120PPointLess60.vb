...
Public Class Admin1120PPointLess60
    Private Sub Admin1120PPointLess60_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        AdminPPLessThan60()
    End Sub

    Public Sub AdminPPLessThan60()
        ...
        Dim command As New SqlCommand("select * from FINAL_1120_COURSE where Microsoft_PowerPoint_Capstone_Project <'60';", connection)
        ...
        Else
            dgvScorePPLess60.DataSource = table
