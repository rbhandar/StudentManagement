...
Public Class Course1123ScoreLess
    Private Sub Course1123ScoreLess_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Course1123ScoreLess60()
    End Sub

    Public Sub Course1123ScoreLess60()
        ...
        Dim command As New SqlCommand("Select * from [FINAL_1123_COURSE] Where Percent_grade <= 0.60;", connection)
        ...
        Else
            ...
            dgvCourse1123ScoreLess.DataSource = table
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        DATAGRIDVIEW_TO_EXCEL((dgvCourse1123ScoreLess)) ' THIS PARAMETER IS YOUR DATAGRIDVIEW
    End Sub
