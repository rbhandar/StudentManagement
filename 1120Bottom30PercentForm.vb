...
Public Class Course1120Bottom30PercentForm
    Private Sub Admin1120Bottom30PercentForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AdminTotalStudent1120Bottom30()
    End Sub

    Public Sub AdminTotalStudent1120Bottom30()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Hide()
        Course1120Bottom30PercentDashboard.Show()
    End Sub
