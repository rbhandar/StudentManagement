...
Public Class Amin1120ScoreLess60All
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Me.Hide()
        Admin1120ProgressForm.Show()
    End Sub
    Private Sub Amin1120ScoreLess60All_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Amin1120ScoreL60All()
    End Sub

    Public Sub Amin1120ScoreL60All()
        ...
        Dim command As New SqlCommand("select * from [FINAL_1120_COURSE] where Microsoft_Word_Capstone_Project <60 and Microsoft_PowerPoint_Capstone_Project <60 and Microsoft_Excel_Capstone_Project <60 and Exam_1_Windows_and_Excel <60 and Exam_2_Word_and_Ppt <60;;", connection)
        ...
        Else
            dgvAllLess60.DataSource = table

        End If
    End Sub

    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        DATAGRIDVIEW_TO_EXCEL((dgvAllLess60)) ' THIS PARAMETER IS YOUR DATAGRIDVIEW
    End Sub
